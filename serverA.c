...
int main(void){
	...
	if(bind(Usock, (struct sockaddr*)&U_adr, sizeof(U_adr))==-1)
		error_handling("bindUA() error");
        else  
            printf("The ServerA is up and running using UDP on port < 21573 >.\n");
    ...
    while(1){
        ...
        //printf("Message %s\n", message);
        printf("The ServerA receiverd a request from the Main Server.\n");
